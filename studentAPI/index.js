...
app.get('gettotalemployee',async(reg,res)=>{
    try{
...
app.get('gettotalregions',async(reg,res)=>{
    try{
...
app.get('gettotallocations',async(reg,res)=>{
    try{
...
app.get('gettotalcountries',async(reg,res)=>{
    try{
...
app.get('gettotaldepartments',async(reg,res)=>{
    try{
